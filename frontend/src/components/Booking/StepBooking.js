	...
	return (
		<div className="info-trip">
			<div className="TrustMessage__Container-sc-8xur6b-0 deVKGv trust-message-container undefined">
				<p className="base__Body02-sc-1tvbuqk-14 VqdXU trust-message-content">Chỉ còn 1 bước nữa! TicketBooking cam kết chỉ sử dụng thông tin trong việc ghi nhận vé.</p>
			</div>
